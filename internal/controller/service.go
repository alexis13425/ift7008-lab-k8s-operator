...
func (s serviceReconciler) Reconcile(parent *travelv1.Traveller) error {
	svc := &corev1.Service{}
...
func (s serviceReconciler) getServiceDefinition(parent *travelv1.Traveller) *corev1.Service {
...
func (s serviceReconciler) createService(parent *travelv1.Traveller) error {
