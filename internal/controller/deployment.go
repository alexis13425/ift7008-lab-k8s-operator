...
func (d deploymentReconciler) Reconcile(parent *travelv1.Traveller) error {
...
func (d deploymentReconciler) getDeplDefinition(parent *travelv1.Traveller) *appsv1.Deployment {
...
func (d deploymentReconciler) createDeployment(parent *travelv1.Traveller) error {
